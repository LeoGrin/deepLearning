...
def training_iters(n_iters, rnn, examplesFunction, criterion=nn.CrossEntropyLoss(), optimizer_name="SGD", print_every=100, plot_every=50,
    ...
    try:
        ...
        for iter in range(1, n_iters + 1):
            ...
            if iter % print_every == 0:
                print(
                '%s (%d %d%%) %.4f' % (timeSince(start), iter, float(iter) / n_iters * 100, total_loss / plot_every))
